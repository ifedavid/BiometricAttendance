...
namespace Fingerprint_Attendance {
    ...
    public partial class Login_DataBaseDataSet1 : global::System.Data.DataSet {
        ...
        public partial class StudentTableDataTable : global::System.Data.TypedTableBase<StudentTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public StudentTableRow AddStudentTableRow(string FullName, string MatricNo, string Level, string Faculty, string Department, string Sex, string FingerPrint) {
        ...
        public partial class StudentTableRow : global::System.Data.DataRow {
            ...
            public string FingerPrint {
                get {
                    try {
                        return ((string)(this[this.tableStudentTable.FingerPrintColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'FingerPrint\' in table \'StudentTable\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableStudentTable.FingerPrintColumn] = value;
                }
            }
            ...
            public bool IsFingerPrintNull() {
                return this.IsNull(this.tableStudentTable.FingerPrintColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetFingerPrintNull() {
                this[this.tableStudentTable.FingerPrintColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Fingerprint_Attendance.Login_DataBaseDataSet1TableAdapters {
    ...
    public partial class StudentTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[StudentTable] ([FullName], [MatricNo], [Level], [Faculty], [Department], [Sex], [FingerPrint]) VALUES (@FullName, @MatricNo, @Level, @Faculty, @Department, @Sex, @FingerPrint);
SELECT Id, FullName, MatricNo, Level, Faculty, Department, Sex, FingerPrint FROM StudentTable WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[StudentTable] SET [FullName] = @FullName, [MatricNo] = @MatricNo, [Level] = @Level, [Faculty] = @Faculty, [Department] = @Department, [Sex] = @Sex, [FingerPrint] = @FingerPrint WHERE (([Id] = @Original_Id) AND ([FullName] = @Original_FullName) AND ([MatricNo] = @Original_MatricNo) AND ([Level] = @Original_Level) AND ((@IsNull_Faculty = 1 AND [Faculty] IS NULL) OR ([Faculty] = @Original_Faculty)) AND ((@IsNull_Department = 1 AND [Department] IS NULL) OR ([Department] = @Original_Department)) AND ((@IsNull_Sex = 1 AND [Sex] IS NULL) OR ([Sex] = @Original_Sex)));
SELECT Id, FullName, MatricNo, Level, Faculty, Department, Sex, FingerPrint FROM StudentTable WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FullName, MatricNo, [Level], Faculty, Department, Sex, FingerPrint FRO" +
                "M dbo.StudentTable";
        ...
        public virtual int Fill(Login_DataBaseDataSet1.StudentTableDataTable dataTable) {
        ...
        public virtual Login_DataBaseDataSet1.StudentTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Login_DataBaseDataSet1.StudentTableDataTable dataTable = new Login_DataBaseDataSet1.StudentTableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Login_DataBaseDataSet1.StudentTableDataTable dataTable) {
        ...
        public virtual int Insert(string FullName, string MatricNo, string Level, string Faculty, string Department, string Sex, string FingerPrint) {
            if ((FullName == null)) {
        ...
        public virtual int Update(string FullName, string MatricNo, string Level, string Faculty, string Department, string Sex, string FingerPrint, int Original_Id, string Original_FullName, string Original_MatricNo, string Original_Level, string Original_Faculty, string Original_Department, string Original_Sex, int Id) {
            if ((FullName == null)) {
                throw new global::System.ArgumentNullException("FullName");
            }
            else {
            ...
            if ((Original_MatricNo == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_MatricNo));
            }
            if ((Original_Level == null)) {
                throw new global::System.ArgumentNullException("Original_Level");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FullName, string MatricNo, string Level, string Faculty, string Department, string Sex, string FingerPrint, int Original_Id, string Original_FullName, string Original_MatricNo, string Original_Level, string Original_Faculty, string Original_Department, string Original_Sex) {
            return this.Update(FullName, MatricNo, Level, Faculty, Department, Sex, FingerPrint, Original_Id, Original_FullName, Original_MatricNo, Original_Level, Original_Faculty, Original_Department, Original_Sex, Original_Id);
        }
    }
